...
class GameAdCardSquare161View(context: Context) : FrameLayout(context) {
    ...
    init {
        ...
        val heightPx = resources.designPx(26)
        ...
        overlay.setPadding(dp(10), 0, dp(10), 0)
        addView(overlay)
        ...
        playButton.applyPreset(size = SlotActionButton.SizePreset.W44_H16, background = SlotActionButton.BackgroundPreset.SOLID_TEAL, radiusPx = 37)
